...
% Carlos Borau (2023). Sankey flow chart (https://www.mathworks.com/matlabcentral/fileexchange/101516-sankey-flow-chart), MATLAB Central File Exchange. Retrieved August 21, 2023.
...
cidx = 1;
try
    givenxlabels = options.categoryNames;
catch
    givenxlabels = [];
end
...
for t = 1:n_layers
    ...
    elseif iscell(givenxlabels)
        layer_point_names{t} = givenxlabels{t};
    else
