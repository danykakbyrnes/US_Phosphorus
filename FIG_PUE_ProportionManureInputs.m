...
fontSize_p = 11;
fontSize_p2 = 8; 
plot_dim = [200,200,400,400];
plot_dim_2 = [200,200,450,425]; 
...
Figfolderpath = [OUTPUT_filepath,'PropManureTotalInput_scatterplot_withRegions.png'];
...
%hold off;
set(gcf,'position',plot_dim_2)
Figfolderpath = [OUTPUT_filepath,'PropManureTotalInput_hexplot_withRegions.png'];
print('-dpng','-r600',Figfolderpath)